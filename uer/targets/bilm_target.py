...
class BilmTarget(LmTarget):
    ...
    def forward(self, memory_bank, tgt):
        ...
        # Forward.
        loss_forward, correct_forward, denominator_forward = self.lm(
            memory_bank[:, :, : self.hidden_size], tgt_forward
        )
        # Backward.
        loss_backward, correct_backward, denominator_backward = self.lm(
            memory_bank[:, :, self.hidden_size :], tgt_backward
        )
